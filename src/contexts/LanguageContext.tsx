...
export const translations: Translations = {
  en: {
    ...
    unknown_msg: "Please upload a clearer image of the affected plant.",
    not_a_plant: "Not a Plant",
    not_a_plant_obs: "The uploaded image does not appear to contain a crop or plant.",
    not_a_plant_cure: "Please upload a clear image of a leaf or agricultural crop.",
    blurry: "Image Too Blurry",
    blurry_obs: "The image is too blurry to identify details.",
    blurry_cure: "Please take a steady, clear photo in focus.",
    low_light: "Low Light",
    low_light_obs: "The image is too dark to accurately assess colors or spots.",
    low_light_cure: "Please move to a well-lit area or use flash.",
    multiple_plants: "Multiple Plants Detected",
    multiple_plants_obs: "There are too many different plants visible in this photo.",
    multiple_plants_cure: "Please focus on a single plant or leaf.",
    leaf_not_visible: "Leaf Not Visible",
    leaf_not_visible_obs: "The affected part of the plant is not clearly visible.",
    leaf_not_visible_cure: "Please take a close-up photo of the affected leaf.",
    uncertain: "Uncertain Diagnosis",
    uncertain_obs: "I cannot diagnose this with high confidence.",
    uncertain_cure: "Please take another clear photo from a different angle.",

    // Auth & Generic TIPS (CROPS)
    rice: "Rice",
    wheat: "Wheat",
    cotton: "Cotton",
    sugarcane: "Sugarcane",
  ...
  te: {
    ...
    unknown_msg: "దయచేసి ప్రభావిత మొక్క యొక్క స్పష్టమైన చిత్రాన్ని అప్‌లోడ్ చేయండి.",
    not_a_plant: "మొక్క కాదు",
    not_a_plant_obs: "ఈ చిత్రంలో మొక్క లేదా పంట ఉన్నట్లు అనిపించడం లేదు.",
    not_a_plant_cure: "దయచేసి మొక్క ఆకు లేదా పంట యొక్క సరైన ఫోటోను అప్‌లోడ్ చేయండి.",
    blurry: "చిత్రం అస్పష్టంగా ఉంది",
    blurry_obs: "వివరాలను గుర్తించడానికి చిత్రం చాలా అస్పష్టంగా ఉంది.",
    blurry_cure: "దయచేసి స్థిరమైన, స్పష్టమైన ఫోటోను తీయండి.",
    low_light: "తక్కువ వెలుతురు",
    low_light_obs: "రంగులు అంచనా వేయడానికి చిత్రం చాలా చీకటిగా ఉంది.",
    low_light_cure: "దయచేసి మంచి వెలుతురు ఉన్న ప్రదేశానికి మారండి లేదా ఫ్లాష్ ఉపయోగించండి.",
    multiple_plants: "అనేక మొక్కలు కనుగొనబడ్డాయి",
    multiple_plants_obs: "ఈ ఫోటోలో చాలా విభిన్న మొక్కలు కనిపిస్తున్నాయి.",
    multiple_plants_cure: "దయచేసి ఒకే మొక్క లేదా ఆకుపై దృష్టి పెట్టండి.",
    leaf_not_visible: "ఆకు కనిపించడం లేదు",
    leaf_not_visible_obs: "మొక్క యొక్క ప్రభావిత భాగం స్పష్టంగా కనిపించడం లేదు.",
    leaf_not_visible_cure: "దయచేసి ప్రభావిత ఆకు యొక్క సమీప ఫోటోను తీయండి.",
    uncertain: "అనిశ్చిత రోగ నిర్ధారణ",
    uncertain_obs: "నేను దీన్ని అధిక నమ్మకంతో నిర్ధారించలేను.",
    uncertain_cure: "దయచేసి వేరొక కోణం నుండి స్పష్టమైన ఫోటో తీయండి.",
